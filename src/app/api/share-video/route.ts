  ...
  <tr><td align="center">
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
      ...
      <tr><td style="padding:0 0 20px 0;">
        <p style="margin:0;font-size:13px;color:#9ca3af;">All-Star Training Knowledge Base</p>
      </td></tr>
      ...
      <tr><td style="padding:0 0 20px 0;">
        <table width="100%" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;border:1px solid #e5e7eb;overflow:hidden;">
          ...
          <tr><td style="padding:24px 24px 28px 24px;">
            ...
            ${video.description ? `
            <!-- Description -->
            <p style="margin:0 0 22px 0;font-size:14px;color:#6b7280;line-height:1.6;">
              ${video.description}
            </p>` : `<div style="margin-bottom:22px;"></div>`}

            <!-- CTA -->
            <a href="${videoUrl}"
              style="display:inline-block;background:${col.bg};color:#ffffff;font-size:14px;font-weight:600;padding:12px 24px;border-radius:10px;text-decoration:none;">
              Watch Video &rarr;
            </a>
      ...
      <!-- Footer links -->
      <tr><td style="padding:4px 0 0 0;text-align:center;">
        <a href="${categoryUrl}" style="font-size:13px;color:#6b7280;text-decoration:none;">Browse ${category} videos</a>
...
export async function POST(req: NextRequest) {
  ...
  const fromEmail = process.env.SHARE_FROM_EMAIL ?? "training@allstartalent.us";
